...
uniform vec3 v3fLightPosition = vec3(-1.0f, 1.0f, 1.0f);
...
void main()
{
	...
	vec3 v3fViewDir = normalize(v3fFragPosition - v3fCameraPosition);
	vec3 v3fReflectDir = reflect(v3fViewDir, v3fNormal);
